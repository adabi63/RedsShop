	...
	<div class="logo_products">
		<div class="container">
			<div class="w3ls_logo_products_left1">		
					<img src="images/lfc.png" width="125px" height="150px" alt="">
					<img src="images/nike.png" width="175px" height="125px" alt="">
			</div>
			<div class="w3ls_logo_products_left">
				<br>
				<br>
				<h1><a href="index.php">The Reds <br> Shop</a></h1>
			</div>
			...
			<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
								<ul class="nav navbar-nav">
									...
									<li style="color:red;">bdbfeafefkeebfkbekjjfbdscbkjhfgkgkgfjegfjvbkfgkugsbjv</li>
		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid">
					...
					<ul class="address">
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Adabi's BaseCamp, SCBD</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="#">information@email</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>+Unknown</li>
					</ul>
				</div>
